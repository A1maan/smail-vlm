#!/bin/bash
# Final-Layer Hidden-State Extraction Pipeline for MedGemma-1.5-4b-IT
# ================================================================
#
# Usage:
#   ./run_extraction.sh
...
# CONFIGURATION
# ============================================
INFERENCE_FILE="${REPO_ROOT}/eval/response_file/medgemma.json"
...
OUTPUT_ROOT="${SCRIPT_DIR}/../results/medgemma"
