#!/bin/bash
# Final-Layer Correction Training Pipeline for MedGemma-1.5-4b-IT
# ============================================================
#
# Usage:
...
# CONFIGURATION
# ============================================
CACHE_DIR="${SCRIPT_DIR}/../results/medgemma/hidden_states"
RUN_DIR="${SCRIPT_DIR}/../results/medgemma/correction_model"
